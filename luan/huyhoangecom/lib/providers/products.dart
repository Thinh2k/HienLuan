...
//from private to public
    ...
    if (authToken != null || userId != null) {
      ...
      var url = Uri.parse(
          //Todo replace .. with realTime database url
           'https://shop-af536-default-rtdb.firebaseio.com//products.json?auth=$authToken&$filteredString');
      try {
        ...
        url = Uri.parse(
            //Todo replace .. with realTime database url
             'https://shop-af536-default-rtdb.firebaseio.com//userFavorites/$userId.json?auth=$authToken');
  ...
  Future<void> addProduct(Product product) async {
    var url = Uri.parse(
        //Todo replace .. with realTime database url
         'https://shop-af536-default-rtdb.firebaseio.com/products.json?auth=$authToken');
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          //Todo replace .. with realTime database url
           'https://shop-af536-default-rtdb.firebaseio.com//products/$id.json?auth=$authToken');
