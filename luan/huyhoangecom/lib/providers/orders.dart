...
//from private to public
  ...
  Future<void> fetchAndSetOrders() async {
    final url = Uri.parse(
        //Todo replace .. with realTime database url
         'https://shop-af536-default-rtdb.firebaseio.com//orders/$userId.json?auth=$authToken'); //userId to bring only my orders
    try {
  ...
  Future<void> addOrder(List<CartItem> cartProduct, double total) async {
    var url = Uri.parse(
        //Todo replace .. with realTime database url
       'https://shop-af536-default-rtdb.firebaseio.com//orders/$userId.json?auth=$authToken');
